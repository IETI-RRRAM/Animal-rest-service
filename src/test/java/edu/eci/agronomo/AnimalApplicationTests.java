...
class AnimalApplicationTests {
	...
	public void testFindByIdExistingAnimal() throws Exception {
		Animal animal = new Animal("117", "caramelo", "cow", "M", "1", "bebe", "weight", "negra");
	...
	void testGetAll() throws Exception {
		...
		Animal animal = new Animal("117", "caramelo", "cow", "M", "1", "bebe", "weight", "negra");
		Animal animal2 = new Animal("JHGKAIG","117", "caramelo", "cow", "M", "1", "bebe", "weight", "negra");
		animals.add(animal);
		animals.add(animal2);
	...
	public void testUpdateExistingAnimal() throws Exception {
		AnimalDto animalDto = new AnimalDto("1", "caramelo", "cow", "M", "1", "bebe", "weight", "negra");
	...
	void testDeleteAnimal() throws Exception {
		Animal animal = new Animal("JHGKAIG","117", "caramelo", "cow", "M", "1", "bebe", "weight", "negra");
